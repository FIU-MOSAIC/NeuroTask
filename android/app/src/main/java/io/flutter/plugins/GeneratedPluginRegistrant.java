...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.cindyu.all_sensors.AllSensorsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin all_sensors, com.cindyu.all_sensors.AllSensorsPlugin", e);
    }
    try {
